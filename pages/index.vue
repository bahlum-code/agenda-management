...
const features = [
  {
    ...
    description:
      "Schedule appointments with ease. Our platform simplifies the booking process, making it quick and intuitive for both patients and providers.",
    icon: CloudArrowUpIcon,
  },
  {
    name: "Secure Payments",
    description:
      "Ensure safe transactions with encrypted payment processing. Accept deposits and full payments securely to confirm appointments.",
    icon: LockClosedIcon,
  },
  {
    name: "Easy Appointment Management",
    description:
      "Manage your appointments efficiently with our user-friendly interface. Easily view, reschedule, or cancel bookings to maintain a smooth workflow.",
    icon: ArrowPathIcon,
  },
  {
    name: "Reliable Data Security",
    description:
      "Protect patient information with robust data security measures. Our system complies with the highest standards to safeguard sensitive data.",
    icon: FingerPrintIcon,
  },
  {
    name: "Comprehensive API Integration",
    description:
      "Integrate effortlessly with existing systems through our comprehensive API. Enhance functionality and streamline operations with seamless data exchange.",
    icon: Cog6ToothIcon,
  },
  {
    name: "Automatic Data Backups",
    description:
      "Never lose important information with automatic data backups. Our system ensures that all your appointment and patient data is securely stored and recoverable.",
    icon: ServerIcon,
  },
];
const tiers = [
        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
          <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
            ...
            <div class="text-center">
              ...
              >
                Simplify Your Scheduling with Ease
              </h1>
              <p class="mt-6 text-lg leading-8 text-gray-300">
                Manage your appointments effortlessly and securely. Whether
                you're booking, paying, or managing your schedule, our platform
                offers a seamless experience. Get started today and discover a
              ...
              <div class="mt-10 flex items-center justify-center gap-x-6">
                ...
                <NuxtLink
                  to="/dashboard"
                  class="text-sm font-semibold leading-6 text-white"
                  >Live demo <span aria-hidden="true">→</span></NuxtLink
                >
              </div>
            </div>
          </div>
        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
          <div class="mx-auto max-w-2xl sm:text-center">
            ...
            <p class="mt-6 text-lg leading-8 text-gray-600">
              Quickly find the best doctors and specialists for your needs. Use
              our powerful search feature to filter by specialty, location, and
              availability. Book your appointments with confidence, knowing
