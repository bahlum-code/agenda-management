        ...
        <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          ...
          <div class="text-center">
            ...
            <p class="mt-6 text-lg leading-8 text-gray-300">
              Manage your appointments effortlessly and securely. Whether you're
              booking, paying, or managing your schedule, our platform offers a
              seamless experience. Get started today and discover a new level of
              convenience.
            </p>
